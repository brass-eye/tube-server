...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { code: @station.code, name: @station.name } }, as: :json
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { code: @station.code, name: @station.name } }, as: :json
    assert_response 200
  end
